...
class RegistroActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        ...
        val url = "http://192.168.1.9/android/registro.php?id=$id"
    ...
    fun eliminar(Vista: View){
        val url = "http://192.168.1.9/android/eliminar.php?id=$id"
        procesoEnCola= Volley.newRequestQueue(this)
    ...
    fun editar(Vista: View){
        val url = "http://192.168.1.9/android/editar.php?id=$id"
        procesoEnCola = Volley.newRequestQueue(this)
